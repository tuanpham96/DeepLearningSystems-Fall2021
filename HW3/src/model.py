...
class EncoderLayer(layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.ffn1 = layers.Dense(units=self.FFN_units, activation=self.act_fun)
...
class Encoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.include_pos_enc = include_pos_enc

        # The embedding layer
        self.embedding = layers.Embedding(vocab_size, d_model)
        # Positional encoding layer
        if self.include_pos_enc:
